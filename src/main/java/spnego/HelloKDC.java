...
public final class HelloKDC {
    ...
    public static void main(final String[] args) throws Exception {
        ...
        final String password = "Serser@1";

        // Name of our krb5 config file
        final String krbfile = "C:\\Users\\q1062\\IdeaProjects\\kerberos\\src\\main\\resources\\krb5-spnego.conf";

        // Name of our login config file
        final String loginfile = "C:\\Users\\q1062\\IdeaProjects\\kerberos\\src\\main\\resources\\jaas-krb5-spnego.conf";

        // Name of our login module
        final String module = "server";
